...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-slack-client/node_modules/slack-client/lib/clients/web/facets/chat.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-slack-client/node_modules/slack-client/lib/clients/web/facets/chat.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-slack-client/node_modules/slack-client/lib/clients/web/facets/</a> &#187; chat.js</div>
</div>
<div class="body">
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function ChatFacet(makeAPICall) {</span>
<span class="cstat-no" title="statement not covered" >  this.name = 'chat';</span>
 ...
 */
ChatFacet.prototype.delete = <span class="fstat-no" title="function not covered" >function delete_(ts, channel, optCb) {</span>
<span class="cstat-no" title="statement not covered" >  var args = {</span>
    ts: ts,
    channel: channel,
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.makeAPICall('chat.delete', args, optCb);</span>
};
&nbsp;
/**
 ...
 * @param {function} optCb Optional callback, if not using promises.
 */
ChatFacet.prototype.postMessage = <span class="fstat-no" title="function not covered" >function postMessage(channel, text, opts, optCb) {</span>
<span class="cstat-no" title="statement not covered" >  var args = {</span>
    channel: channel,
    text: text,
    opts: opts,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.makeAPICall('chat.postMessage', args, optCb);</span>
};
&nbsp;
/**
 * Updates a message.
 ...
 * @param {function} optCb Optional callback, if not using promises.
 */
ChatFacet.prototype.update = <span class="fstat-no" title="function not covered" >function update(ts, channel, text, opts, optCb) {</span>
<span class="cstat-no" title="statement not covered" >  var args = {</span>
    ts: ts,
    channel: channel,
    text: text,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.makeAPICall('chat.update', args, optCb);</span>
};
&nbsp;
&nbsp;
